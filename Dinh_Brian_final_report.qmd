...
(basically lots of old buildings, but also growing number of new ones, weird peak of around 100 yr old buildings)
...
brooklyn_sales_res |> 
  ...
  filter(sale_price < 4000000, #outlier removal
         ...
         building_age < 250) |>  #outlier removal
  group_by(building_age) |> 
...
```
older is more expensive???? but also dip in the mid-50s ish, maybe less refurbishments.
